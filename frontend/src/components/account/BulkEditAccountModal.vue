    ...
    <form id="bulk-edit-account-form" class="space-y-5" @submit.prevent="() => handleSubmit()">
      ...
      <div v-if="allOpenAIAPIKey" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          <div class="flex-1 pr-4">
            <label
              id="bulk-edit-openai-responses-message-partial-compat-label"
              class="input-label mb-0"
              for="bulk-edit-openai-responses-message-partial-compat-enabled"
            >
          ...
          <input
            ...
            type="checkbox"
            aria-controls="bulk-edit-openai-responses-message-partial-compat"
            class="rounded border-gray-300 text-primary-600 focus:ring-primary-500"
          />
        </div>
        <div
          id="bulk-edit-openai-responses-message-partial-compat"
          :class="!enableOpenAIResponsesMessagePartialCompat && 'pointer-events-none opacity-50'"
        >
          <button
            type="button"
