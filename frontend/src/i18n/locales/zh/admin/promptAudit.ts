export default {
  promptAudit: {
    ...
    actions: { refresh: '刷新运行态', retry: '重试', Record: '仅留存', Allow: '放行', Warn: '警告', Block: '阻止' },
    ...
    decisions: { unreviewed: '未审核', pass: '通过', flag: '标记', critical: '严重' },
    riskLevels: { unknown: '未知', low: '低', medium: '中', high: '高', critical: '严重' },
    scanners: {
      violent: '暴力',
    ...
    events: {
      ...
      captureOnlyTitle: '仅留存记录',
      captureOnlyNotice: '此事件仅保存了用户提示词，没有调用审计 API，因此尚未审核，也没有风险判定或 Guard 返回。',
      riskSummaries: '风险摘要',
      evidence: '脱敏证据',
      score: '分数',
