    ...
    accounts: {
      ...
      openai: {
        ...
        responsesMessagePartialCompatDesc:
          'OpenAI API Key accounts only. Normalizes Responses messages for Volcengine Ark: partial=true is used only on the final message item; all other messages omit partial.',
