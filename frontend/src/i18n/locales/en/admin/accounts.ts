    ...
    accounts: {
      ...
      openai: {
        ...
        responsesMessagePartialCompatDesc:
          'OpenAI API Key accounts only. Normalizes Responses messages for Volcengine Ark: only the final assistant message carries partial=true; historical messages omit partial.',
