export default {
    accounts: {
      ...
      video: {
        ...
        providers: { seedance: 'Seedance', kling: 'Kling' },
        apiKey: 'API key',
        accessKey: 'Access key',
        secretKey: 'Secret key',
        apiKeyPlaceholder: 'Enter the Seedance API key',
        accessKeyPlaceholder: 'Enter the Kling access key',
        secretKeyPlaceholder: 'Enter the Kling secret key',
        secretConfigured: 'Secret configured',
        baseUrlPlaceholder: 'https://api.example.com',
        baseUrlHint: 'Optional HTTPS root URL. Provider validation is enforced by the server.',
        modelMappingHint: 'Map every public model name to one exact upstream model or endpoint ID. Wildcards are not supported.',
        capabilities: 'Available capabilities',
        capabilitiesUnavailable: 'No capabilities are reported by the API for this account.',
        disableCapability: 'Disable {capability}',
        capability: {
          audio: 'Audio', edit: 'Edit', extension: 'Extension',
          first_and_last_frame: 'First and last frame', first_frame: 'First frame',
          generation: 'Generation', last_frame: 'Last frame',
          reference_images: 'Reference images', reference_videos: 'Reference videos', text: 'Text'
        },
        invalidBaseUrl: 'Enter a valid provider HTTPS root URL.',
        apiKeyRequired: 'Seedance API key is required.',
        klingCredentialsRequired: 'Kling access key and secret key are required.',
        invalidConfiguration: 'Complete a valid video provider configuration and at least one exact model mapping.',
        invalidMetadata: 'This video account has unknown or legacy metadata and cannot be edited safely.'
      },
      types: {
        oauth: 'OAuth',
      ...
      openai: {
        ...
        responsesMessagePartialCompatDesc:
          'OpenAI API Key accounts only. Normalizes Responses messages for Volcengine Ark: empty text-only history messages are removed; partial=true is used only when the final input item is an assistant message; shorthand messages are supported and all other messages omit partial.',
        responsesAssistantPrefillCompat: 'Responses assistant prefill compatibility',
        responsesAssistantPrefillCompatDesc:
          'OpenAI API Key accounts only. For upstreams without assistant prefill support, remove empty text-only history messages, then preserve a final assistant message and append a minimal user continuation to avoid an upstream 400.',
