-- Group video-generation permission is part of the API-key auth snapshot.
-- Replace the latest function body from migration 193 so direct group writes
-- durably invalidate cached authorization while preserving every prior field.
