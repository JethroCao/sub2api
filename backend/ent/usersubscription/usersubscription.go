...
const (
	...
	// FieldFrozenQuota holds the string denoting the frozen_quota field in the database.
	FieldFrozenQuota = "frozen_quota"
...
var (
	...
	// DefaultFrozenQuota holds the default value on creation for the "frozen_quota" field.
	DefaultFrozenQuota float64
...
// ByFrozenQuota orders the results by the frozen_quota field.
func ByFrozenQuota(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFrozenQuota, opts...).ToFunc()
}
