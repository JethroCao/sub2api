...
func TestShouldUsePreaggregatedTrendRejectsNativeCompactionV2Filter(t *testing.T) {
	nativeCompactionV2 := true
	require.True(t, shouldUsePreaggregatedTrend("day", 0, nil, 0, 0, 0, "", nil, nil, nil, "", nil, nil))
	require.False(t, shouldUsePreaggregatedTrend("day", 0, nil, 0, 0, 0, "", nil, nil, nil, "", nil, &nativeCompactionV2))
}
