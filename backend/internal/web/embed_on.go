...
func (s *FrontendServer) serveIndexHTML(c *gin.Context) {
	...
	if err != nil {
		// Fallback: serve last rendered HTML if available, otherwise without injection.
	...
	// The cache is per process, but settings can be updated by any instance in a
	// distributed deployment. Revalidate against the current settings payload
	// before serving cached HTML.
	if cached := s.cache.GetForSettings(settingsJSON); cached != nil {
