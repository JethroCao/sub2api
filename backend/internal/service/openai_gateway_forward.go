...
func (s *OpenAIGatewayService) Forward(ctx context.Context, c *gin.Context, account *Account, body []byte) (*OpenAIForwardResult, error) {
	...
	if passthroughEnabled {
		...
		originalBody, _, err = normalizeOpenAIResponsesMessageContentForAccount(account, originalBody)
		if err != nil {
			return nil, err
		}
	...
	body, _, err = normalizeOpenAIResponsesMessageContentForAccount(account, body)
	if err != nil {
		return nil, err
	}
